/* eslint-disable unicorn/filename-case, react/no-unescaped-entities */
/* @jsx jsx */
...
const TermsAndConditions: React.FC = () => {
  return (
    ...
    >
      ...
      <p>Welcome to lop.si!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use of lop.si's
        Website, located at https://lop.si.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue
        to use lop.si if you do not agree to take all of the terms and conditions stated on this
      ...
      <p>
        We employ the use of cookies. By accessing lop.si, you agreed to use cookies in agreement
        with the lop.si's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, lop.si and/or its licensors own the intellectual property rights
        for all material on lop.si. All intellectual property rights are reserved. You may access
        this from lop.si for your own personal use subjected to restrictions set in these terms and
        conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from lop.si</li>
        <li>Sell, rent or sub-license material from lop.si</li>
        <li>Reproduce, duplicate or copy material from lop.si</li>
        <li>Redistribute content from lop.si</li>
      </ul>
      ...
      <p>
        ...
        information in certain areas of the website. lop.si does not filter, edit, publish or review
        Comments prior to their presence on the website. Comments do not reflect the views and
        opinions of lop.si,its agents and/or affiliates. Comments reflect the views and opinions of
        the person who post their views and opinions. To the extent permitted by applicable laws,
        lop.si shall not be liable for the Comments or for any liability, damages or expenses caused
        and/or suffered as a result of any use of and/or posting of and/or appearance of the
        Comments on this website.
      </p>

      <p>
        lop.si reserves the right to monitor all Comments and to remove any Comments which can be
      ...
      <p>
        You hereby grant lop.si a non-exclusive license to use, reproduce, edit and authorize others
      ...
      <p>
        ...
        visibility of the hyperlink compensates the absence of lop.si; and (d) the link is in the
      ...
      <p>
        ...
        linking to our website, you must inform us by sending an e-mail to lop.si. Please include
      ...
      <p>
        No use of lop.si's logo or other artwork will be allowed for linking absent a trademark
        license agreement.
      </p>
...
/* eslint-enable unicorn/filename-case, react/no-unescaped-entities */
