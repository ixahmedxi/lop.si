...
const PrivacyPolicy: React.FC = () => {
  return (
    ...
    >
      ...
      <p>
        At lop.si, accessible from https://lop.si, one of our main priorities is the privacy of our
        visitors. This Privacy Policy document contains types of information that is collected and
        recorded by lop.si and how we use it.
      </p>
      ...
      <p>
        ...
        website with regards to the information that they shared and/or collect in lop.si. This
      ...
      <p>
        lop.si follows a standard procedure of using log files. These files log visitors when they
      ...
      <p>
        ...
        Beacons that are used in their respective advertisements and links that appear on lop.si,
      ...
      <p>
        Note that lop.si has no access to or control over these cookies that are used by third-party
        advertisers.
      </p>
      ...
      <p>
        lop.si's Privacy Policy does not apply to other advertisers or websites. Thus, we are
      ...
      <p>
        lop.si does not knowingly collect any Personal Identifiable Information from children under
